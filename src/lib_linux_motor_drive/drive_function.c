...
void initialize_position_profile_limits(int slave_number, ctrlproto_slv_handle *slv_handles)
{
	slv_handles[slave_number].profile_position_params.qei_params.ticks_resolution = \
			slv_handles[slave_number].motor_config_param.s_position_encoder_resolution.position_encoder_resolution; //set qei resolution
	slv_handles[slave_number].profile_position_params.hall_params.pole_pairs = slv_handles[slave_number].motor_config_param.s_pole_pair.pole_pair; //set pole pairs
