...
{												//ALIAS / POSITION / CONFIG_NUMBER
		...
		SOMANET_C22_CTRLPROTO_SLAVE_HANDLES_ENTRY(0,             1, 	1),
		SOMANET_C22_CTRLPROTO_SLAVE_HANDLES_ENTRY(0,             2, 	1),
		SOMANET_C22_CTRLPROTO_SLAVE_HANDLES_ENTRY(0,             3, 	1)
};
